...
public interface ChecksumPolicy
{
     ...
     * repository.
     *
     * @param name The name of the checksum algorithm being used, must not be {@code null}.
     ...
     */
    boolean onChecksumMatch( String name, int kind );
     ...
     */
    void onChecksumMismatch( String name, int kind, ChecksumFailureException exception )
     ...
     *                                  validation continues with the next checksum.
     */
    void onChecksumError( String name, int kind, ChecksumFailureException exception )
            throws ChecksumFailureException;
