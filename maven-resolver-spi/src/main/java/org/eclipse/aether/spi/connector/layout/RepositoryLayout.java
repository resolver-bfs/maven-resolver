...
public interface RepositoryLayout
{
     ...
     * underlying checksum type used to calculate/verify it.
     */
    final class ChecksumLocation
    {
         ...
         *                                 null}.
         */
        public ChecksumLocation( ChecksumAlgorithmFactory checksumAlgorithmFactory, URI location )
        {
            verify( checksumAlgorithmFactory, location );
        ...
        public static ChecksumLocation forLocation( URI location, ChecksumAlgorithmFactory checksumAlgorithmFactory )
        {
            ...
            return new ChecksumLocation( checksumAlgorithmFactory,
                    URI.create( location + "." + checksumAlgorithmFactory.getExtension() ) );
        }

        private static void verify( ChecksumAlgorithmFactory checksumAlgorithmFactory, URI location )
        {
